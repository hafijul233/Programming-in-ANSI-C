...
int main()
{
  ...
  float customer1_bill, customer2_bill;
      ...
      //customer 1
      if(customer1 <= 100) customer1_bill = service_cost;
        else customer1_bill = service_cost+(customer1 * 1.25);

      //customer 2
      if(customer2 <= 100) customer2_bill = service_cost;
        else  customer2_bill = service_cost+(customer2 * 1.25);
